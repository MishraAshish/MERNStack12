...
// fsObj.readFile("./shorthandd.js","utf-8",(err, data)=>{ //error first callback
//     console.log(err)
//     console.log(data)
// }) 


// //this is blocking operation other lines will only execute once file read operation is done
...
writerStream.on("finish", ()=>{ //attached an event from eventemitter class
    ...
    fsObj.readFile('./Text2.json','utf8',(err, fileData)=>{ //error first call back : error will always be a first object when executes with node modules
